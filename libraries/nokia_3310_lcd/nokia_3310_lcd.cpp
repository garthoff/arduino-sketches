 ...
 * Return value : none 
 */
void Nokia_3310_lcd::drawBitmap( unsigned char x,unsigned char y,
	unsigned char *map, unsigned char size_x,unsigned char size_y) {
 ...
 * Return value : none 
 */
void Nokia_3310_lcd::drawBitmapP( unsigned char x,unsigned char y,
		const prog_char *map,
 ...
 * Return value : none 
 */
void Nokia_3310_lcd::clearBitmap( unsigned char x,unsigned char y,
                  unsigned char size_x,unsigned char size_y)
  {
    unsigned int i,n;
    unsigned char row;
 ...
 * Return value : none
 */
void Nokia_3310_lcd::writeCharBig (unsigned char x,unsigned char y,
...
#ifdef USE_GRAPHIC
       lcd_buffer[cursor_row][cursor_col + j] = (mode == MENU_NORMAL)? ch_dat : (ch_dat^0xff);
#endif
